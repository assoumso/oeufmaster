...
import { WalletCards, Plus, TrendingDown, Calendar, PieChart } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-140px)]">
      ...
      <div className="w-full lg:w-1/3 flex flex-col gap-6">
        ...
        {/* Summary Card */}
        <div className="bg-gradient-to-br from-red-500 to-red-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-64">
             <h3 className="font-bold text-gray-700 mb-2 text-sm uppercase tracking-wider flex items-center gap-2">
                ...
                <table className="w-full text-left">
                    <tbody className="divide-y divide-gray-100">
                        {expenses.sort((a,b) => new Date(b.date).getTime() - new Date(a.date).getTime()).map(exp => (
                         ...
                         {expenses.length === 0 && (
                            <tr>
                                <td colSpan={2} className="p-8 text-center text-gray-400">Aucune dépense enregistrée.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
